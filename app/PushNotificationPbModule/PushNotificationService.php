...
class PushNotificationService extends BaseService{
    ...
    public function __construct(){
        parent::__construct(new PushNotificationUpdator(),new PushNotificationConvertor(),new PushNotificationSearcher(),new PushNotificationSearchResponsePb(),PushNotificationTableName::getTableName());
    }
}
