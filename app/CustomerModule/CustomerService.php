...
class CustomerService extends BaseService
{
    ...
    {
        parent::__construct(new CustomerPb(), new CustomerUpdator(), new CustomerConvertor(), new CustomerSearcher(), new CustomerSearchResponsePb(), CustomerTableName::getTableName());
    }
}
